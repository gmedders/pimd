...
mt19937::mt19937(data_type s) throw() {
  seed(s);
}
...
void
mt19937::seed(data_type n) throw() {
  if (n == 0)
...
mt19937::data_type
mt19937::operator()(data_type begin, data_type end) throw() {
...
double
mt19937::operator()(const double& begin, const double& end) throw() {
